...
{
	// 頂点座標の設定
	object->vertexWk[0].vtx.x = object->pos.x - cosf(angle + object->rot.z) * Length;
	object->vertexWk[0].vtx.y = object->pos.y - sinf(angle + object->rot.z) * Length;
	object->vertexWk[0].vtx.z = 0.0f;						 

	object->vertexWk[1].vtx.x = object->pos.x + cosf(angle - object->rot.z) * Length;
	object->vertexWk[1].vtx.y = object->pos.y - sinf(angle - object->rot.z) * Length;
	object->vertexWk[1].vtx.z = 0.0f;						 
												 
	object->vertexWk[2].vtx.x = object->pos.x - cosf(angle - object->rot.z) * Length;
	object->vertexWk[2].vtx.y = object->pos.y + sinf(angle - object->rot.z) * Length;
	object->vertexWk[2].vtx.z = 0.0f;						 
												 
	object->vertexWk[3].vtx.x = object->pos.x + cosf(angle + object->rot.z) * Length;
	object->vertexWk[3].vtx.y = object->pos.y + sinf(angle + object->rot.z) * Length;
	object->vertexWk[3].vtx.z = 0.0f;
}
